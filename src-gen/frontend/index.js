...
FrontendApplicationConfigProvider.set({
    "applicationName": "Skills Network - Cloud IDE",
    "defaultTheme": "dark",
...
module.exports = nls.loadTranslations().then(() => {
    ...
    .then(function () { return Promise.resolve(require('skills-network-extension/lib/browser/skills-network-frontend-module')).then(load) })
